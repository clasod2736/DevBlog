...
export default function MobileNavBar({ closeToggle }: Props) {
  return (
    <section className="flex flex-col fixed right-5 bottom-1 justify-center items-center text-md animate-shortFadeIn h-full w-2/3 min-w-[230px] sm:hidden bg-zinc-900 gap-10 z-10 border-x-4 border-x-zinc-500">
      <Link
        href="/"
