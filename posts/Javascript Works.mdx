...
It means working only one task at the time. At this point, <code>Promise</code> and <code>async & await</code> show up.
...
ex) v8 for Chrome<br/>
And javascript engine is formed with <code>Memory Heap</code> and <code>Call Stack.</code>
...
In each tasks in "Call Stack", we call them <code>Stack Frame</code>.<br/>
...
We called that <code>Stack Overflow</code>
...
This area for temporarily saving event handler or callback of async function like <code>setTimeout</code>
