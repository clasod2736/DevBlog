...
4. Go to "Property" category edit "Static web hosting" section
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/bucket2.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'bucket2'}
   />
...
2. Cache behavior section.
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront1.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront1'}
   />
...
3. Set HTTPS with SSL certificates.
   ...
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront2.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront2'}
   />
...
4. Origin setting.
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront3.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront3'}
   />
...
5. Error pages setting.
   ...
   {' '}
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront4.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront4'}
   />
...
3. Create record type "A"
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront6.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront6'}
   />
...
4. Go to ACM service and click your certificate for your cloudfront distribution.
   <img
     src={'/images/posts/Deploying S3 & Cloudfront on AWS/cloudfront5.jpg'}
     class="inline"
     style={{ height: 'auto', width: '100%' }}
     alt={'cloudfront5'}
   />
