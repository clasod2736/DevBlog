...
2. Check object ownership to <u><strong style={{color:'darkgoldenrod'}}>ACLs disabled(recommended)</strong></u>
...
5. Upload objects of your web-app
   If you built web-app in Next.js you need to set a few config in next.config.js file =><u><strong style={{color:'darkgoldenrod'}}>for next.js "13.5.4" version</strong></u>
...
2. Add name-server values in your domain platform.
   Inside of hosted zone page you wil see the record that has <b style={{color:'darkgoldenrod'}}>"NS"</b> then copy those 4 values and add in your domain platform.
